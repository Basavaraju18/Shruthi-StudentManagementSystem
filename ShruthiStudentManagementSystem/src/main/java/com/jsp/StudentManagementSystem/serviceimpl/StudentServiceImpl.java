...
public class StudentServiceImpl implements StudentService{
	...
	public ResponseEntity<String> sendMimeMessage(MessageData messageData) throws MessagingException   {
		String body=messageData.getText()+"<br><br>"
				+"<h4>Thanks and Regards<br>"
				+messageData.getSenderName()+"<br>"+
				messageData.getSenderAddress()+"</h4>"+"<img src=\"https://www.jspiders.com/_nuxt/img/logo_jspiders.3b552d0.png\" width=\"250\" height=\"100\">";
